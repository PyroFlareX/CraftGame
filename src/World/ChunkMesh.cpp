...
void ChunkMesh::addFace(const std::array<float, 12>& blockFace, const std::array<float, 8>& texCoords, const vn::vec3i & chunkPos, const vn::vec3i & blockPos)
{
	faces++;
	auto &verticies = m_mesh.vertices;
	auto &indices = m_mesh.indicies;
